...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fs(e,t,n){let r=new Float32Array(xs),i=new G(0,1,0);return new ja({name:`SphericalGaussianBlur`,defines:{n:xs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Rs(),fragmentShader:`
	...
	`}var zs=class extends dn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new _a(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		`});T.wrapS=y,T.wrapT=y,u.position.set(3,6,-3),u.lookAt(C),f.visible=!1,i.position.copy(g),a.target.copy(C),a.minPolarAngle=Math.PI*.22,a.maxPolarAngle=Math.PI*.68,a.minAzimuthAngle=-2.75,a.maxAzimuthAngle=-2.1,a.minDistance=10.8,a.maxDistance=12.6,a.enableDamping=!0,a.autoRotate=!0,a.autoRotateSpeed=.2,a.rotateSpeed=.42,a.zoomSpeed=.45,a.enablePan=!1,a.touches={ONE:_.ROTATE,TWO:_.DOLLY_PAN},e&&(i.position.set(-7.35,1.72,-11.35),a.target.set(1.5,2.95,0),a.enableRotate=!1,a.enableZoom=!1,a.enableDamping=!1,a.autoRotate=!1),E.group.position.copy(p),t.add(u,d,E.group,w,f);let O=0,k,A=!1;function j(){if(!v)return;let e=v.clientWidth,t=v.clientHeight;!e||!t||(i.aspect=e/t,i.updateProjectionMatrix(),r.setSize(e,t))}let ee=new ResizeObserver(j);ee.observe(v),j();function te(){A||(E.leavesCount>0&&Math.random()>.25&&E.deadID.push(Math.floor(Math.random()*E.leavesCount)),k=setTimeout(te,3800+Math.random()*2e3))}function ne(e){let t=e.clone();return t.onBeforeCompile=e=>{e.uniforms.uPumpkinShadeA={value:new Y(12537368)},e.uniforms.uPumpkinShadeB={value:new Y(14842410)},e.uniforms.uPumpkinShadeC={value:new Y(16759384)},e.fragmentShader=`
				...
				`+e.fragmentShader,e.fragmentShader=e.fragmentShader.replace(`#include <output_fragment>`,`
					...
					`)},t.customProgramCacheKey=()=>`pumpkin-stylized-v1`,t}async function M(){try{let e=await n.loadAsync(`${h}/objects/pumpkin-5f977e.glb`);if(A)return;let t=e.scene,r=new ur().setFromObject(t).getSize(new G),i=.42/Math.max(r.y,.001),a=new G(p.x+.32,.52,p.z+.28);for(let e of[{offset:[-.92,.03,.62],scale:.92,rotationY:.35,rotationZ:-.03},{offset:[1.1,.04,.26],scale:1.05,rotationY:2.4,rotationZ:.02},{offset:[.24,.01,-.9],scale:.84,rotationY:4.65,rotationZ:-.02},{offset:[-.28,.05,1.08],scale:1.12,rotationY:5.5,rotationZ:.04}]){let n=t.clone(!0);n.traverse(e=>{e instanceof hi&&(e.material=Array.isArray(e.material)?e.material.map(e=>ne(e)):ne(e.material))}),n.scale.setScalar(i*e.scale),n.position.set(a.x+e.offset[0],a.y+e.offset[1],a.z+e.offset[2]),n.rotation.y=e.rotationY,n.rotation.z=e.rotationZ,w.add(n)}}catch{}}function re(e){if(!v)return;let t=v.getBoundingClientRect(),n=(e.clientX-t.left)/t.width,r=(e.clientY-t.top)/t.height;if(n<0||n>1||r<0||r>1)return;c.set(n*2-1,-(r*2)+1),l.setFromCamera(c,i);let a=[];E.leaves&&a.push(E.leaves),a.push(f);let o=l.intersectObjects(a);o[0]&&(f.position.copy(o[0].point),f.position.multiplyScalar(.9),f.lookAt(i.position),D.uniforms.uRaycast.value=o[0].point,typeof o[0].instanceId==`number`&&Math.random()*5>3&&E.leavesCount>0&&E.deadID.push(o[0].instanceId))}v.addEventListener(`mousemove`,re),n.loadAsync(`https://raw.githubusercontent.com/ceramicSoda/treeshader/main/assets/tree.glb`).then(e=>{if(A)return;if(m(x,!1),E.pole=e.scene.getObjectByName(`Pole`)??void 0,E.pole&&E.pole.material){let e=E.pole,t=e.material;e.material=new Fa({map:t.map??null})}E.crown=e.scene.getObjectByName(`Leaves`)??void 0;let t=e.scene.getObjectByName(`Leaf`);if(!E.crown||!t)return;let n=E.crown,r=n.geometry,i=r.attributes.position,a=r.attributes.normal;if(!i||!a)return;let s=new ur().setFromObject(n);D.uniforms.uBoxMin.value.copy(s.min),D.uniforms.uBoxSize.value.copy(s.getSize(new G)),E.leavesCount=Math.ceil(i.count*.65),E.deadID=[],E.leaves=new Vi(t.geometry,D,E.leavesCount);for(let e=0;e<E.leavesCount;e++){let t=Math.floor(e*i.count/E.leavesCount);o.position.set(i.array[t*3],i.array[t*3+1],i.array[t*3+2]),o.lookAt(o.position.x+a.array[t*3],o.position.y+a.array[t*3+1],o.position.z+a.array[t*3+2]),o.scale.setScalar(Math.random()*.2+.8),o.updateMatrix(),E.leaves.setMatrixAt(e,o.matrix)}for(let e=0;e<8;e++)E.deadID.push(Math.floor(Math.random()*E.leavesCount));E.group.add(...[E.pole,E.leaves].filter(Boolean)),E.group.position.copy(p),M(),te()}).catch(()=>{m(S,!0)});function ie(){O=requestAnimationFrame(ie),D.uniforms.uTime.value+=.0025,E.leaves&&E.deadID.length>0&&(E.deadID=E.deadID.filter(e=>(E.leaves.getMatrixAt(e,s),s.decompose(o.position,o.quaternion,o.scale),o.position.y<=0?!1:(o.position.y-=.04,o.position.x+=Math.random()/5-.11,o.position.z+=Math.random()/5-.11,o.rotation.x+=.2,o.updateMatrix(),E.leaves.setMatrixAt(e,o.matrix),!0))),E.leaves.instanceMatrix.needsUpdate=!0),a.update(),r.render(t,i)}return ie(),()=>{A=!0,k&&clearTimeout(k),cancelAnimationFrame(O),ee.disconnect(),v?.removeEventListener(`mousemove`,re),a.dispose(),r.dispose(),T.dispose(),D.dispose(),t.clear()}});var C=Vd(),w=n(C),T=n(w);f(T,e=>b=e,()=>b),i(w),f(w,e=>v=e,()=>v);var E=a(w,2),D=e=>{var n=Bd();let r;l(()=>r=u(n,1,`tree-preview svelte-14xb4g5`,null,r,{"tree-preview--failed":t(S)})),p(e,n)};c(E,e=>{t(x)&&e(D)}),i(C),p(s,C),o()}export{Hd as default};